...
def load_system_prompt() -> str:
    ...
    prompt_path = os.path.normpath(os.path.join(current_dir, "..", "prompts", "ats_system.txt"))
    
    if not os.path.exists(prompt_path):
        raise FileNotFoundError(f"Arquivo de prompt do sistema não encontrado em: {prompt_path}")
